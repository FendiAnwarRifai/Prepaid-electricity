													...
													<div class="m-dropdown__content">
														<ul class="m-nav m-nav--skin-light">
															...
															<li class="m-nav__item">
																<a href="profadmin{{ Auth::user()->id }}" class="m-nav__link">
					...
					<div class="m-stack__item m-stack__item--middle m-stack__item--fluid">
						...
						<div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-dark m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-light m-aside-header-menu-mobile--submenu-skin-light ">
							<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
								...
								<li class="m-menu__item " aria-haspopup="true"><a href="/home" class="m-menu__link "><span class="m-menu__item-here"></span><span class="m-menu__link-text">Dashboard</span></a></li>

								<li class="m-menu__item " aria-haspopup="true"><a href="listpel" class="m-menu__link "><span class="m-menu__item-here"></span><span class="m-menu__link-text">User</span></a></li>
										...
										<span class="m-menu__link-title">
											<span class="m-menu__link-wrap">
												...
												<span class="m-menu__link-badge">
													<span class="m-badge m-badge--danger">{{$data}}</span>
												</span>
											</span>
										</span>
										@endif
									...
									<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left">
										...
										<ul class="m-menu__subnav">
											<li class="m-menu__item" aria-haspopup="true">
												<a href="pending" class="m-menu__link ">
											...
											<li class="m-menu__item m-menu__item--active" m-menu-link-redirect="1" aria-haspopup="true"><a href="detail" class="m-menu__link "><i class="m-menu__link-icon flaticon-share"></i><span class="m-menu__link-text">Detail Transaksi</span></a></li>
...
<script src="switch_button/assets/demo/custom/crud/forms/widgets/bootstrap-switch.js" type="text/javascript"></script>
</body>
