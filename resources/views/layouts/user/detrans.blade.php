					...
					<div class="m-stack__item m-stack__item--middle m-stack__item--fluid">
						...
						<div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-dark m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-light m-aside-header-menu-mobile--submenu-skin-light ">
							...
							<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
								...
								<li class="m-menu__item" aria-haspopup="true"><a href="/beranda" class="m-menu__link "><span class="m-menu__item-here"></span><span class="m-menu__link-text">Dashboard</span></a></li>
								...
								<li class="m-menu__item  m-menu__item--submenu m-menu__item--rel m-menu__item--active " m-menu-submenu-toggle="click" aria-haspopup="true">
									...
									<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
										<ul class="m-menu__subnav">
											...
											<li class="m-menu__item m-menu__item--active" m-menu-link-redirect="1" aria-haspopup="true"><a href="detail_transaksi" class="m-menu__link "><i class="m-menu__link-icon flaticon-share"></i><span class="m-menu__link-text">Detail Transaksi</span></a></li>
